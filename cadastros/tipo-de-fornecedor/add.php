...
$consulta = $pdo->query("SELECT codigo FROM tipo_de_fornecedor ORDER BY codigo DESC LIMIT 0,1");
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="tipo_de_fornecedor_add" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="tipo_de_fornecedor_add_form">
                                    <input name="type" type="hidden" value="tipo_de_fornecedor_add" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox-inline mt-lg-5">
                                                    <label class="checkbox">
                                                        <input type="checkbox" name="destacar">
                                                        <span></span>
                                                        Destaca Fluxo
                                                    </label>
...
<script src="<?= $url ?>assets/js/cadastros/tipo-de-fornecedor/add.js"></script>