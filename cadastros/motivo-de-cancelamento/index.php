            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item text-muted">
                        <a href="" class="text-muted">Motivo de Cancelamento</a>
                    </li>
        ...
        <div class="d-flex align-items-center">
            <div class="btn-group ml-2">
                ...
                <a href="add" class="btn btn-primary font-weight-bold btn-sm">
                    ...
                    </span>Novo Motivo de Cancelamento</a>
            </div>
            <!--begin::Daterange-->
...
<script src="<?= $url ?>assets/js/cadastros/motivo-de-cancelamento/ajax.js"></script>