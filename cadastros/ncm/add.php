...
$consulta = $pdo->query("SELECT codigo FROM ncm ORDER BY codigo DESC LIMIT 0,1");
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="ncm_add" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="ncm_add_form">
                                    <input name="type" type="hidden" value="ncm_add" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-2">
                                            ...
                                            <input type="text" class="form-control ncm" name="ncm" placeholder="NCM">
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-2">
                                            <label>Cofins:</label>
                                            <input type="text" class="form-control money2Mask" name="cofins" value="0,00" placeholder="Cofins">
                                        </div>
                                    </div>
                                    <!--begin::Actions-->
...
<script src="<?= $url ?>assets/js/cadastros/ncm/add.js"></script>