    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="vendedor_add" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="vendedor_add_form">
                                    <input name="type" type="hidden" value="vendedor_add" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-2 ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control percentMask" name="p_comissao" placeholder="Comissão" />
                                            </div>
                                        </div>
...
<script src="<?= $url ?>assets/js/cadastros/vendedor/add.js"></script>