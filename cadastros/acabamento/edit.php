...
$consulta = $pdo->query("SELECT * FROM acabamento WHERE id_acabamento = " . $id);
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item text-muted">
                        <a href="<?= $url ?>acabamento" class="text-muted">Ambiente</a>
                    </li>
                    <li class="breadcrumb-item text-muted">
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="acabamento_edit" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="acabamento_edit_form">
                                    <input name="id" type="hidden" value="<?= $id ?>" />
                                    <input name="type" type="hidden" value="acabamento_edit" />
...
<script src="<?= $url ?>assets/js/cadastros/acabamento/edit.js"></script>