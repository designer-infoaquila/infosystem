...
$consulta = $pdo->query("SELECT * FROM ambiente WHERE id_ambiente = " . $id);
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="ambiente_edit" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="ambiente_edit_form">
                                    <input name="id" type="hidden" value="<?= $id ?>" />
                                    <input name="type" type="hidden" value="ambiente_edit" />
...
<script src="<?= $url ?>assets/js/cadastros/ambiente/edit.js"></script>