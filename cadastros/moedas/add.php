    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="moeda_add" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="moeda_add_form">
                                    <input name="type" type="hidden" value="moeda_add" />

                                    <div class="form-group row">
                                        <div class="col-12 col-lg-4">
                                            <label>Data:<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control dateMask" name="data" placeholder="Data">
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <label>Moeda</label>
                                        ...
                                        <div class="col-12 col-lg-4">
                                            ...
                                            <input type="text" class="form-control moneyMask" name="valor" placeholder="Valor">
                                        </div>
...
<script src="<?= $url ?>assets/js/cadastros/moedas/add.js"></script>