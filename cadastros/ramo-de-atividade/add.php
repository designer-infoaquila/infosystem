...
$consulta = $pdo->query("SELECT codigo FROM ramo_de_atividade ORDER BY codigo DESC LIMIT 0,1");
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="ramo_de_atividade_add" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="ramo_de_atividade_add_form">
                                    <input name="type" type="hidden" value="ramo_de_atividade_add" />
...
<script src="<?= $url ?>assets/js/cadastros/ramo-de-atividade/add.js"></script>