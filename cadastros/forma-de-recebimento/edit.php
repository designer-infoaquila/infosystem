...
$consulta = $pdo->query("SELECT * FROM forma_de_recebimento WHERE id_recebimento = " . $id);
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="forma_de_recebimento_edit" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="forma_de_recebimento_edit_form">
                                    <input name="id" type="hidden" value="<?= $id ?>" />
                                    <input name="type" type="hidden" value="forma_de_recebimento_edit" />
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-2">
                                            ...
                                            <select class="form-control" name="gerar_contas_receber" required>
                                                <option>...</option>
                                                <option value="0" <?= $linha['gerar_contas_receber'] == 0 ? 'selected' : '' ?>>Não</option>
                                                <option value="1" <?= $linha['gerar_contas_receber'] == 1 ? 'selected' : '' ?>>Sim</option>
                                            </select>
                                        </div>
...
<script src="<?= $url ?>assets/js/cadastros/forma-de-recebimento/edit.js"></script>