...
var KTFornecedorAdd = (function () {
			...
			if (validator) {
				...
				validator.validate().then(function (status) {
					if (status == 'Valid') {
						...
						//Form data
						var form_data = $('#fornecedor_add_form').serializeArray();
						...
						$.ajax({
							...
							error: function (xhr, desc, err) {
								Swal.fire({
									html: 'Fornecedor não foi inserido!',
									icon: 'error',
									buttonsStyling: false,
									confirmButtonText: 'OK, entendi!',
									customClass: {
	...
	*/
	return {
		// public functions
		init: function () {
			_wizardEl = KTUtil.getById('fornecedor_add');
			_formEl = KTUtil.getById('fornecedor_add_form');
