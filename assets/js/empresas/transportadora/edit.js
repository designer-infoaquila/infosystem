...
// Class definition
var KTTransportadoraEdit = (function () {
	// Base elements
	var _wizardEl;
	var _formEl;
	var _wizardObj;
			...
			if (validator) {
				validator.validate().then(function (status) {
					if (status == 'Valid') {
						...
						//Form data
						var form_data = $('#transportadora_edit_form').serializeArray();
						...
						$.ajax({
							...
							error: function (xhr, desc, err) {
								Swal.fire({
									html: 'Transportadora não foi atualizada!',
									icon: 'error',
									buttonsStyling: false,
									confirmButtonText: 'OK, entendi!',
									customClass: {
	...
	*/
	return {
		// public functions
		init: function () {
			_wizardEl = KTUtil.getById('transportadora_edit');
			_formEl = KTUtil.getById('transportadora_edit_form');
