...
var KTProdutoEdit = (function () {
			...
			if (validator) {
				validator.validate().then(function (status) {
					if (status == 'Valid') {
						...
						//Form data
						var form_data = $('#produto_edit_form').serializeArray();
						...
						$.ajax({
							...
							error: function (xhr, desc, err) {
								Swal.fire({
									html: 'Produto não foi atualizado!',
									icon: 'error',
									buttonsStyling: false,
									confirmButtonText: 'OK, entendi!',
									customClass: {
	...
	return {
		// public functions
		init: function () {
			_wizardEl = KTUtil.getById('produto_edit');
			_formEl = KTUtil.getById('produto_edit_form');
