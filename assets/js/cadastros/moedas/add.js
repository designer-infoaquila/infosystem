...
var KTAdd = (function () {
			...
			if (validator) {
				...
				validator.validate().then(function (status) {
					if (status == 'Valid') {
						...
						//Form data
						var form_data = $('#moeda_add_form').serializeArray();
						...
						$.ajax({
							...
							success: function (data, status) {
								...
								if (resposta[0] == 'success') {
									Swal.fire({
										title: 'Inserido!',
										text: 'Moeda inserida com sucesso',
										icon: 'success',
										timer: 1000,
										onOpen: function () {
											Swal.showLoading();
	...
	return {
		// public functions
		init: function () {
			_wizardEl = KTUtil.getById('moeda_add');
			_formEl = KTUtil.getById('moeda_add_form');
