...
var KTNCMEdit = (function () {
			...
			if (validator) {
				validator.validate().then(function (status) {
					if (status == 'Valid') {
						...
						//Form data
						var form_data = $('#ncm_edit_form').serializeArray();
	...
	return {
		// public functions
		init: function () {
			_wizardEl = KTUtil.getById('ncm_edit');
			_formEl = KTUtil.getById('ncm_edit_form');
