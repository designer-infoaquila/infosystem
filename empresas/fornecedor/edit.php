...
$consulta = $pdo->query("SELECT * FROM fornecedor WHERE id_fornecedor = " . $id);
...
while ($linhaTipoFornecedor = $consultaTipoFornecedor->fetch(PDO::FETCH_ASSOC)) {
    ...
    if ($linha['tipo_fornecedor'] == $linhaTipoFornecedor['codigo']) {
        $loopTipoFornecedor .= '<option value="' . $linhaTipoFornecedor['codigo'] . '" selected>' . $linhaTipoFornecedor['descricao'] . '</option>';
    } else {
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="fornecedor_edit" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="fornecedor_edit_form">
                                    <input name="type" type="hidden" value="fornecedor_edit" />
                                    <input name="id" type="hidden" value="<?= $linha['id_fornecedor'] ?>" />
...
<script src="<?= $url ?>assets/js/empresas/fornecedor/edit.js"></script>