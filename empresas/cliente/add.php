...
$consulta = $pdo->query("SELECT codigo FROM clientes ORDER BY codigo DESC LIMIT 0,1");
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="cliente_add" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="cliente_add_form">
                                    <input name="type" type="hidden" value="cliente_add" />
                                        ...
                                        <div class="col-12 col-lg-3">
                                            ...
                                            <div class="checkbox-inline">
                                                <label class="checkbox mt-3">
                                                    <input type="checkbox" name="isento">
                                                    <span></span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg">
                                            <label class="alter-name-2">Razão Social:</label>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12 col-lg-2">
                                            <label>CEP:</label>
                                            <input type="text" class="form-control cepMask2" name="cep2" placeholder="CEP" required>
                                            <span class="form-text text-muted text-cep-validator2 text-danger"></span>
                                        </div>
                                        <div class="col-12 col-lg-8">
                                            <label>Endereço:</label>
                                            <input type="text" class="form-control endereco2" name="endereco2" placeholder="Endereço">
                                        </div>
                                        <div class="col-12 col-lg-2">
                                            <label>Numero:</label>
                                            <input type="text" class="form-control numero2" name="numero2" placeholder="Numero">
                                            <input type="hidden" class="form-control ibge2" name="ibge2">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12 col-lg-4">
                                            <label>Complemento:</label>
                                            <input type="text" class="form-control" name="complemento2" value="" placeholder="Complemento">
                                        </div>
                                        <div class="col-12 col-lg-3">
                                            <label>Bairro:</label>
                                            <input type="text" class="form-control bairro2" name="bairro2" placeholder="Bairro">
                                        </div>
                                        <div class="col-12 col-lg-3">
                                            <label>Cidade:</label>
                                            <input type="text" class="form-control cidade2" name="cidade2" placeholder="Cidade">
                                        </div>
                                        <div class="col-12 col-lg-2">
                                            <label>Estado:</label>
...
<script src="<?= $url ?>assets/js/empresas/cliente/add.js"></script>