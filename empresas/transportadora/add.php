...
$consulta = $pdo->query("SELECT codigo FROM transportadora ORDER BY codigo DESC LIMIT 0,1");
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="transportadora_add" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="transportadora_add_form">
                                    <input name="type" type="hidden" value="transportadora_add" />
...
<script src="<?= $url ?>assets/js/empresas/transportadora/add.js"></script>