...
<style>
    ...
    .table tbody td:nth-last-child(3):not(.dataTables_empty) {
        display: flex;
        justify-content: space-evenly;
    }

    #kt_datatable th:nth-last-child(1),
    #kt_datatable td:nth-last-child(1):not(.dataTables_empty),
    ...
    <div class="w-100 d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item text-muted">
                        <a href="" class="text-muted">Notas Fiscais</a>
                    </li>
        ...
        <div class="d-flex align-items-center">
            <div class="btn-group ml-2">
                ...
                <a href="add" class="btn btn-primary font-weight-bold btn-sm">
                    ...
                    </span>Nova Nota Fiscal</a>
            </div>
            <div class="btn-group ml-2">

                <a href="carta-correcao" class="btn btn-danger font-weight-bold btn-sm">
                    <span class="svg-icon svg-icon-md">
...
<script src="<?= $url ?>assets/js/nota-fiscal/ajax.js"></script>