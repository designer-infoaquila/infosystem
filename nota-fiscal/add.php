    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="nota_add" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="nota_add_form">
                                    <input type="hidden" name="type" value="nota_add" />
                                    <input type="hidden" name="id_cfop" />

                                    <div class="form-group row">
                                        <div class="col-12 col-lg-12">
                                            <h2><b>Nota Fiscal Nº <?= $nota_fiscal ?></b></h2>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-lg-2">
                                            ...
                                            <div class="input-icon input-icon-right">
                                                <input type="text" class="form-control form-control-sm" name="cfop" placeholder="CFOP" autocomplete="INFOSYSTEM" readonly>
                                                <span>
                                                    <a href="#" class="listaCFOP" data-toggle="modal" data-target="#listaCFOP"><i class="flaticon2-search-1 icon-md"></i></a>
                                                </span>
                                            </div>
                                    ...
                                    <div class="row mb-10">
                                        <div class="col-12 col-lg-12">
                                            ...
                                            <input type="text" name="infcpl" class="form-control form-control-sm" value="DOCUMENTO EMITIDO POR ME OU EPP OPTANTE PELO SIMPLES NACIONAL. NAO GERA DIREITO A CREDITO FISCAL DE ICMS, ISS E IPI.">
